import { ShoppingCart, Home, Menu, Phone, HelpCircle, ChevronRight, ChevronLeft, UtensilsCrossed } from "lucide-react";
    ...
    <div className="w-full overflow-x-hidden">
        ...
        <nav className="absolute top-0 left-0 w-full z-50">
          <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <ul className="flex space-x-8">
              ...
              <Link to="/Menu1">
              <li><a href="#menu" className="flex items-center gap-2 text-white font-medium hover:text-amber-600"><Menu size={20}/> Menu</a></li>
              </Link>
              ...
              <Link to="/Login">
              <li><a href="#login" className="flex items-center gap-2 text-white font-medium hover:text-amber-600"> Login</a></li>
              </Link>
            </ul>
            <div className="flex items-center gap-6">
              <Link to="/Cart">
              <div className="relative cursor-pointer text-white hover:text-amber-600">
                <ShoppingCart size={24}/>
              </div>
              </Link>
              <a href="#book" className="bg-black hover:bg-amber-200 text-white px-4 py-2 rounded-lg">Book Table</a>
            </div>
          </div>
        </nav>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center">
          ...
          <Link to="/TableOrder">
          <a href="#contact" className="bg-amber-600 hover:bg-amber-700 text-white px-6 py-3 rounded-xl shadow-lg text-lg font-semibold transition mt-8">
            Reserve Now
          </a>
          </Link>
        </div>
